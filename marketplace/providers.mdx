...
After creation, you'll see the agent detail page with six configuration tabs:
...
<Note>
  Prices are stored in cents internally. $0.05 = 5 cents.
</Note>
...
The provider dashboard displays key metrics and activity at a glance.
