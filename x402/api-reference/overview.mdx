...
<Note>
Get your API key from the [Dashboard](https://facilitator.agentokratia.com). API keys are tied to your receiving wallet and work on all supported EVM networks.
</Note>
