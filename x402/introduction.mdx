...
<CardGroup cols={2}>
  <Card title="exact" icon="receipt" href="/quickstart#exact-scheme-quickstart">
    **Per-request payments**

    Standard x402. One signature per API call. Simple, no pre-deposit needed.
  </Card>
  <Card title="escrow" icon="vault" href="/quickstart#escrow-scheme-quickstart">
...
<Card title="Detailed Scheme Comparison" icon="code-compare" href="/concepts/schemes">
...
<CardGroup cols={2}>
  <Card title="Client Developers" icon="laptop" href="/quickstart#client-exact">
  ...
  <Card title="API Providers" icon="server" href="/quickstart#server-exact">
...
<CardGroup cols={2}>
  ...
  <Card title="Non-Custodial" icon="shield-check">
    Escrow funds held in audited smart contract
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Get API Key" icon="key" href="/getting-api-key">
