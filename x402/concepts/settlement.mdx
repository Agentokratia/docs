...
<Info>
The escrow settlement is powered by [Base's Commerce Payments Protocol](https://blog.base.dev/commerce-payments-protocol), implementing the authorize-capture pattern used by traditional payment processors like Stripe and Adyen.
</Info>
...
sequenceDiagram
    ...
    Facilitator->>Facilitator: Validate amount ≤ captured
