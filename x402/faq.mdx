...
The escrow contract is built on [Base's Commerce Payments Protocol](https://blog.base.dev/commerce-payments-protocol), a production-grade payment infrastructure:

- **Open source**: [View the smart contract on GitHub](https://github.com/base/commerce-payments/blob/main/src/AuthCaptureEscrow.sol)
