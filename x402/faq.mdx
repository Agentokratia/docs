...
See [Refund vs Reclaim](/concepts/settlement#refund-vs-reclaim) for details.
...
See our [React example](/integration/client#react-example) for integration patterns.
...
1. Get testnet API key (`ak_test_`) from [facilitator.agentokratia.com](https://facilitator.agentokratia.com)
